...
{
    private TimeSpan _vibrationTimeRemaning = TimeSpan.Zero;
    ...
    public void Update(GameTime gameTime)
    {
        ...
        if (_vibrationTimeRemaning > TimeSpan.Zero)
        {
            _vibrationTimeRemaning -= gameTime.ElapsedGameTime;
